...
class BasicHandlers:
    ...
    def __init__(self, locale_manager: LocaleManager, keyboard_manager: KeyboardManager, user_dao: UserDAO, config):
    ...
    async def _set_language(self, query, user_id: int, new_language: str) -> None:
        ...
        try:
            ...
            success = await self.user_dao.update_user_language(user_id, new_language)
